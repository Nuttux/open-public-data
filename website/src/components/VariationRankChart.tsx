    ...
    <div className="w-full">
      ...
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-slate-100 flex items-center gap-2">
          {t('chart.evolution')} {data.periode.debut} → {data.periode.fin}
        </h3>
        <p className="text-sm text-slate-400">
          {t('chart.variation_desc')}
        </p>
      </div>
      ...
      <div className="flex items-center gap-4 mb-4 text-xs text-slate-400">
        <div className="flex items-center gap-1.5">
          ...
          <span>{t('chart.increase')}</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="w-3 h-3 rounded bg-red-500"></span>
          <span>{t('chart.decrease')}</span>
        </div>
      </div>
      ...
      <SingleVariationChart
        ...
        isMobile={isMobile}
        title={t('chart.revenue_sources')}
        subtitle={t('chart.revenue_sources_desc')}
        icon=""
        accentColor="emerald"
      />
      ...
      <SingleVariationChart
        ...
        periode={data.periode}
        isMobile={isMobile}
        title={t('chart.expenditure_dest')}
        subtitle={t('chart.expenditure_dest_desc')}
        icon=""
        accentColor="rose"
      />
