  ...
  return (
    <footer className="fx-foot">
      <div className="fx-wrap">
        ...
        <nav aria-label={t("fx.foot.legal.accessibilite") + ", " + t("fx.foot.legal.confidentialite")} style={{ paddingTop: 18, display: "flex", gap: 16, flexWrap: "wrap", fontFamily: "var(--f-mono)", fontSize: 11, letterSpacing: ".04em" }}>
