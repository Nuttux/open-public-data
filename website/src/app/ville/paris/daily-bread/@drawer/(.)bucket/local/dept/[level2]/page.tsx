...
export default async function DrawerDeptPage({
  params,
  searchParams,
}: {
  ...
  // National absolute : APUL.S1313 × part_departements × share_of_parent
  // (depuis 2026-05 : sync_eurostat_apu_subsectors.py expose annual_eur via
  // nama_10_gdp). Avant cette date c'était "—" car le PIB n'était pas publié.
