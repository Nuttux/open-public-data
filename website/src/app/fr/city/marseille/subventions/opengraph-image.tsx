...
export default async function MarseilleSubventionsOG() {
  const d = loadQuiRecoitData(undefined, "marseille");
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Subventions · Ville de Marseille · {d.year}
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          <div style={{ display: "flex" }}>franceopendata.org/ville/marseille/subventions</div>
        </div>
      </div>
    ),
    { ...size },
