...
export async function generateMetadata(): Promise<Metadata> {
  return buildLocaleAwareMetadata({
    ...
    en: {
      ...
      description:
        "Technical architecture, sources, dbt models, LLM enrichments, editorial choices, limits, and open code: the full methodology behind every tool on Données Lumières.",
    },
    path: "/methode",
  });
}
