...
1. **Paris meets the SRU law overall, but not by arrondissement.** This nuance never appears in quick political commentary, but it is decisive for understanding the absence of penalty at the municipal level.
...
3. **The deficiency ruling is the truly dissuasive weapon**: it triggers multiplication of the levy and transfer of the pre-emption right to the prefect. But it applies to durably deficient municipalities, not to Paris.
