...
<svg viewBox="0 0 720 320" xmlns="http://www.w3.org/2000/svg" className="fx-svg" role="img" aria-label="Investissement annuel de la Ville de Paris 2017-2026">
  ...
  <text x="580" y="84" fontFamily="JetBrains Mono, monospace" fontSize="10" fill="#e11d1d" textAnchor="middle">pic 1 733 M€</text>
...
<figcaption>Investissement réel hors dette de la Ville de Paris, 2019-2024 (Compte Administratif M57). Le pic de 2024 (1 733 M€) dépasse de 15 % le niveau de 2019 (1 510 M€). Source : pipeline open-public-data, dataset `comptes-administratifs-budgets-principaux-m57-ville-departement`.</figcaption>
</figure>
