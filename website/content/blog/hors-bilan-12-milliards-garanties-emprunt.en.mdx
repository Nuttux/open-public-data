...
Key takeaway: **the off-balance-sheet outstanding amount grew by +21% between 2019 and 2024**, at a pace comparable to the City's own debt (+55% over the same period — the gap comes from the fact that the off-balance-sheet aggregate started much higher). More importantly, **the off-balance-sheet aggregate now exceeds the own-debt aggregate**: €12.28Bn versus €10.70Bn.
...
What it does say, in one sentence: **the €12.28Bn of loan guarantees granted by the City to third parties represents a real contingent commitment, larger than the City's own debt, almost entirely concentrated on social housing and the Caisse des Dépôts**. This is not a hidden debt — it is a debt **whose servicing does not weigh on the City as long as the system functions**. But it is an aggregate that no public debate on Parisian debt should omit.
